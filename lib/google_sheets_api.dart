  ...
  static const _credentials = r'''
{
  ...
  static Future loadTransactions() async {
    ...
    for (int i = 1; i <= numberOfTransactions; i++) {
      ...
      final String dateString = await _worksheet!.values.value(column: 4, row: i + 1);
  ...
  static Future insert(String name, String amount, bool _isIncome, DateTime date) async {
    if (_worksheet == null) return;
    numberOfTransactions++;
    currentTransactions.add([
      name,
  ...
  static Future update(int rowIndex, String name, String amount, bool isIncome, DateTime date) async {
    ...
    await _worksheet!.values.insertRow(rowIndex + 1, [
      name,
      amount,
      isIncome ? 'income' : 'expense',
      DateFormat('yyyy-MM-dd').format(date) 
  ...
  static Future delete(int rowIndex) async {
    ...
    await _worksheet!.deleteRow(rowIndex + 1);
  }
